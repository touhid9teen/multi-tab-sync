...
} from "@/hooks/use-request-counter";
    ...
    <div className="min-h-screen bg-[#F9FAFB] p-8 lg:p-24 font-sans">
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Link
            href="/broadcast-lab"
            className="group p-8 bg-white rounded-[32px] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-blue-100 transition-all duration-500 relative overflow-hidden"
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-sm text-gray-400 font-medium leading-relaxed">
                Single-origin event bus. Best for instant, decentralized
                synchronization between same-origin tabs.
              </p>
            </div>
          </Link>
          ...
          <Link
            href="/worker-lab"
            className="group p-8 bg-white rounded-[32px] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-indigo-100 transition-all duration-500 relative overflow-hidden"
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-sm text-gray-400 font-medium leading-relaxed">
                Centralized background threads. Ideal for complex state
                management and resource pooling across tabs.
              </p>
            </div>
          </Link>
          ...
          <Link
            href="/polling-lab"
            className="group p-8 bg-white rounded-[32px] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-purple-100 transition-all duration-500 relative overflow-hidden"
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-sm text-gray-400 font-medium leading-relaxed">
                Stale-while-revalidate fallback. Guarantees synchronization when
                modern browser APIs are unavailable.
              </p>
            </div>
          </Link>
        </div>
